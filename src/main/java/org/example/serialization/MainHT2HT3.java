...
public class MainHT2HT3 {
    public static void main(String[] args) {
        ...
        File forZip = new File("E:/Programming/Netology/Games/savegames/forZip");
        forZip.mkdir();
        saveGames("E:/Programming/Netology/Games/savegames/forZip/save1.dat", gp1);
        saveGames("E:/Programming/Netology/Games/savegames/forZip/save2.dat", gp2);
        saveGames("E:/Programming/Netology/Games/savegames/forZip/save3.dat", gp3);
        zipFiles("E:/Programming/Netology/Games/savegames/zip.zip", "E:/Programming/Netology/Games/savegames/forZip");
        forZip.delete();
        openZip("E:/Programming/Netology/Games/savegames/zip.zip", "E:/Programming/Netology/Games/savegames/");
        openProgress("E:/Programming/Netology/Games/savegames/!save3.dat");
    }
